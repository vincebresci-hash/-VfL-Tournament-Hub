-- Fix MeinTurnierplan sync: reconcile existing Hub groups/fields by name
-- before insert, to avoid tournament_groups_tournament_name_idx conflicts.
-- Additive: replaces sync_mein_turnierplan_tournament only.
