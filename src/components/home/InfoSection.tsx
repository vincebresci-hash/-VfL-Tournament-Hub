          ...
          {columns.map((column) => {
            ...
            return (
              <article
                key={column.title}
                className={cn(
                  "flex h-full flex-col rounded-[12px] border border-line bg-white",
              ...
              >
                <Icon className="h-7 w-7 shrink-0 text-brand-yellow" aria-hidden="true" />
                ...
                <Link
                  href={column.href}
                  className="mt-3 inline-flex min-h-11 items-center text-[12px] font-semibold tracking-[0.08em] text-ink uppercase transition-colors hover:text-brand-blue focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-brand-yellow sm:mt-3.5 lg:mt-4"
                >
                  {column.linkLabel}
                </Link>
              </article>
